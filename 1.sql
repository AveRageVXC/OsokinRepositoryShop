...
INSERT INTO users (name, surname, login, password, telephone, date_of_registration, birth_date) VALUES ("Ваня", "Иванов", "vanyaivanov@mail.ru", 12312314313, "+79174357634", "2019.12.03", "1999.12.30");
INSERT INTO users (name, surname, login, password, telephone, date_of_registration, birth_date) VALUES ("Пётр", "Чортов", "petya123@mail.ru", 542345341, "+79165434565", "2016.10.14", "1998.05.12");
INSERT INTO users (name, surname, login, password, telephone, date_of_registration, birth_date) VALUES ("Аделина", "Борисова", "tebyalublya@mail.ru", 92304234233, "+79169876677", "2011.01.23", "1976.10.24");
